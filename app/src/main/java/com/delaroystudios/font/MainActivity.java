package com.delaroystudios.font;
...
import com.tutorialsbuzz.customfont.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface face_01 = Typeface.createFromAsset(getAssets(), "customfont/dragon.otf");
        mTextView_01.setTypeface(face_01);

        Typeface face_02 = Typeface.createFromAsset(getAssets(), "customfont/motionpicture.ttf");
        mTextView_02.setTypeface(face_02);

        Typeface face_03 = Typeface.createFromAsset(getAssets(), "customfont/poster.ttf");
